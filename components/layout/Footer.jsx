        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 text-gray-300">
              {["Services", "Web journal", "About Us", "Contact"].map(
                (item) => (
                  <li
                    key={item}
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-gray-300 mb-8 text-[15px]">
              ...
              exclusive offers, and tips on how to make the most of your
              Remitium experience. Stay connected and never miss out on the news
              that matters to you!
            </p>
