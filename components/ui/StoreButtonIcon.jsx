export const AppStoreIcon = ({ className = "" }) => {
  return (
    <div
      className={`flex w-48 h-14 bg-black text-white rounded-xl items-center justify-center cursor-pointer ${className}`}
    >
      <div className="mr-3">
      ...
      <div>
        ...
        <div className="text-2xl font-semibold -mt-1">App Store</div>
      </div>
    </div>
  );
};

export const GooglePlayIcon = ({ className = "" }) => {
  return (
    <div
      className={`flex w-48 h-14 bg-black text-white rounded-lg items-center justify-center cursor-pointer ${className}`}
    >
      <div className="mr-3">
